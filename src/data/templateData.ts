...
export const templateData: Record<string, TemplatePage> = {
  ...
  maya: {
    ...
    title: 'Maya',
    description:
      'Serif editorial portfolio — scroll progress, magnetic cursor, hover project previews.',
    tier: 'free',
    stack: 'html',
  ...
  altura: {
    ...
    previewType: 'video',
    previewVideoUrl: '/previews/altura.mp4',
  ...
  lumen: {
    ...
    previewType: 'video',
    previewVideoUrl: '/previews/lumen.mp4',
    zipFileName: 'lumen.zip',
    isNew: true,
  },
  overclock: {
    id: 'overclock',
  ...
  etude: {
    ...
    previewType: 'video',
    previewVideoUrl: '/previews/etude.mp4',
